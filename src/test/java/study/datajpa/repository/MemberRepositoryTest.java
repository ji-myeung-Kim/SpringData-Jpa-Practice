...
//        }
    ...
    public void bulkUpdate() {
        ...
        //when
        /**
         * bulk연산잔는 영속성 컨테스트를 거치지 않고 바로 db에 때려박음(영속성 컨텍스트에서 인지 못함)
         * em.flush() - 변경되지 않은 내용 db에 반영
         * em.clear를 통해 영속성 컨테스트를 비워줘야 함 -> @Modifying(clearAutomatically = true)
         * 깔끔한 상태에서 DB에서 다시 가져옴(41로 바뀐상태에서) - 원래는 영속성 컨테스트에는 40, db에는 41
         */
